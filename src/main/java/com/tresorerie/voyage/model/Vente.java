...
public class Vente implements Serializable {
    ...
    @NotNull(message = "Le montant total de la vente est obligatoire.")
    ...
    @NotNull(message = "L'utilisateur lié à la vente est obligatoire.")
    private MyAppUser user; // Association avec l'utilisateur
